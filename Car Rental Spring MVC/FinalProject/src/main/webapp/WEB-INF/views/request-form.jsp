...
<div class="well">
	<form action="${contextPath}/postCar/requestMessage" method="post">
	<table border="1" cellpadding="2" cellspacing="2" class="table table-hover">
		<tr>
			<td><b>Posted By</b></td>
			<td>${postCar.user.firstName}</td>
		</tr>
		<tr>
		...
		<tr>
			<td><b>DEPARTURE</b></td>
			<td>${postCar.arrivalFrom}</td>
		</tr>
		<tr>
			<td><b>DESTINATION</b></td>
			<td>${postCar.destinationTo}</td>
		</tr>
		<tr>
			<td><b>MESSAGE</b></td>
		...
		<tr>
			<td colspan="2"><button type="submit" name="send" value="${postCar.postId}">Send</button></td>
		</tr>
