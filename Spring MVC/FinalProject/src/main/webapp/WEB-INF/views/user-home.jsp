...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <a href="${contextPath}/postCar/add" ><button type="button" class="btn btn-success">Post Car</button></a><br><br>
    <a href="${contextPath}/postCar/view" ><button type="button" class="btn btn-success">View Posted Car</button></a><br><br>
    <a href="${contextPath}/postCar/messageList" ><button type="button" class="btn btn-success">View Messages</button></a>
	</center>
