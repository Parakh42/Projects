<%-- 
    Document   : search
    Created on : 14 Aug, 2017, 8:08:13 PM
    Author     : parak
--%>
...
<html>
    ...
    <body>
        ...
        <c:forEach var="i" begin="1" end="1" items="${sessionScope.outArray}">

            <h5 style="padding-left: 25px; color: #808080;">About <c:out value="${i.result}"/> results (0.31 seconds)</h5>    
        </c:forEach>
        <table>
            <c:forEach items="${sessionScope.outArray}" var="data">


                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>Path:</b><a href="C:\tomcat8\webapps\DocumentPath\${data.fileName}">${data.path}</a></td></tr>
                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>FileName:</b> <c:out value="${data.fileName}"/></td></tr>
                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>Snippet:</b> <c:out value="${data.contentsArray}"/></td></tr>
                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>Ranking Score:</b> <c:out value="${data.rankingScore}"/></td></tr>
                <tr><td>&nbsp;&nbsp;<br></td></tr>
                    </c:forEach>
        </table>
