 ...
 * @author parak
 */
public class SingleSearchFile {

    List<Data> conArray;

    public SingleSearchFile() {
    ...
    public List<Data> searching(String key) throws IOException, ParseException, InvalidTokenOffsetsException {
...
//            String q = "/"""+key+"/""";
        ...
        //Query query1 = parser.parse(key1);
//             //operator
